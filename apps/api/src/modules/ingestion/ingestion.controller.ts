...
export class IngestionController {
  ...
  @Delete("sync")
  cancelSync(@Param("repoId") repoId: string, @Req() request: { user: { id: string } }, @Headers("x-workspace-id") workspaceId?: string) {
    return this.ingestionService.cancelSync(repoId, request.user.id, workspaceId);
  }
